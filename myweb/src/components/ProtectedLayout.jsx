        ...
        return (
            <div className="flex h-full">
                <div className="w-[12rem]">
                    ...
                    <button class="bg-transparent hover:bg-red-500 text-red-500 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded justify-end w-[10rem] h-[6rem]" style={{margin: '10px'}} onClick={logoutBtn_Click}>Logout</button>
                </div>
                <Outlet />
            </div>
        )
