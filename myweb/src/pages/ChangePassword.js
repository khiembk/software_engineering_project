...
export default function ChangePassword() {
  ...
  const changepassBtn_Click = async (e) => {
    ...
    if(UserNewPassword !== UserNewPassword2){
        ...
        setAttempt("New password is less than 6 characters!");
    }
    else{
        try{
            const response = await fetchFunction({
                reqType: '/changePass/nomalUser',
                UserId: user.UserId,
  ...
  return (
    <div className='m-auto text-center'>
      <h1 className="text-center text-gray-700 font-bold text-[2rem]" style={{marginBottom: '20px'}}>Đổi mật khẩu người dùng</h1>
